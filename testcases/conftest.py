...
def pytest_configure(config):
    config.option.htmlpath =os.path.join(os.path.abspath("C:\\Users\\usha5\\PycharmProjects\\Opencart_Project\\"), "reports", f"{datetime.datetime.now().strftime('%d-%m-%Y %H-%M-%S')}.html")
